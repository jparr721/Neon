...
namespace meshing::optimizer {
    ...
    /// Computes the list of edges from a given mesh
    ...
    /// Collapses the sliver elements and updates the vertices and faces
    /// \param min_theta The min value of theta for the triangle to perform the edge collapse
    ...
    void EdgeCollapseSlivers(Real min_theta, MatrixXr &V, MatrixXi &F, MatrixXi &E);
}// namespace meshing::optimizer
